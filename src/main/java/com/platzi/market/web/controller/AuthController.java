...
import com.platzi.market.domain.services.PlatziUsersDetailsService;
...
public class AuthController {
    ...
    public ResponseEntity<AuthenticationResponse> createToken(@RequestBody AuthenticationRequest authenticationRequest){
        try {
            ...
            UserDetails userDetails = this.platziUsersDetailsService.loadUserByUsername(authenticationRequest.getUsername());
